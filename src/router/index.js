...
const UpdateProduct = () =>
    import ('@/views/Products/updateProduct')
const NewProduct = () =>
    import ('@/views/Products/newProduct')
const Promotions = () =>
    import ('@/views/Promotions/Promo/Promotions')
const NewPromotion = () =>
    import ('@/views/Promotions/Promo/NewPromotion')
const NewBanner = () =>
    import ('@/views/Promotions/Banner/NewBanner');
const Faqs = () =>
    import ('@/views/faqs/faq.vue')
const Profile = () =>
    import ('@/views/base/Profile.vue')
const Message = () =>
    import ('@/views/contact_message/messages.vue');
